            ...
            <>
                <div style={{ margin: 'auto' }}>
                    <Paper className={classes.reportWrapper}>
                        <Typography style={{ width: '100%', marginTop: '4rem', textAlign: 'center', justifyContent: 'center', fontSize: 69, fontWeight: 'bolder' }}>Suggestions</Typography>
                        ...
                        <Typography variant="body1" style={{width: '100%', textAlign: 'left', fontSize: 20 }}>Your Pace is optimal, which is between the range of 150 WPM - 200 WPM. You don't need further correction.</Typography>
                        ...
                        <Typography variant="body1" style={{width: '100%', textAlign: 'left', fontSize: 20 }}>Overall Emotion of the video is <strong>neutral</strong>. You need to be more excited while answering or querying the interviwer.</Typography>
                        ...
                        <Typography variant="body1" style={{width: '100%', textAlign: 'left', fontSize: 20 }}>You can use following words to improve your interview effictiveness.</Typography>
                        <ul>
